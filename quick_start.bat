...
flask db migrate -m "Add LeadNote model and relationship"
flask db migrate -m "add library_progress"
flask db migrate -m "Add LibraryItem.unlisted"
flask db migrate -m "Add badge and reaction models"
flask db upgrade
